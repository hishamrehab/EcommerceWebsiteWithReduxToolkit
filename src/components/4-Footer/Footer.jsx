    ...
    <div className="footer-section">
      <div className="brand-directory">
        ...
        <div className="fashion">
          <span className="fristword">FASHION :</span> T-Shirt: Shirts | Shorts
          & Jeans | Jacket | Dress & Frock | InnerWear | Hosiery
        </div>
        <div className="fashion">
          <span className="fristword">FOOTWEAR : </span> Formal | Boots | Casual
          | Cowboy Shoes | Safety Shoes | Party Wear Shoes | Branded | Firstcopy
          | Long Shoes
        </div>
        <div className="fashion">
